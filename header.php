...
session_start();
if(!isset($page_title)) { $page_title = 'Puzzle Page!'; }
...
<nav class="navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <a href="index.php" title="twoscoops"><img src="Images/index_images/twoscoops.png"></a> 
        ...
        <li class="nav-item">
            ...
            if (isset($_SESSION['role'])){
                echo '<li class="nav-item active"><a class="nav-link" id="header" href="puzzles_list.php">Questions List<span class="sr-only">(current)</span></a>';
